/* @flow strict-local */
import { ApiErrorCode, ApiResponseErrorData } from './transportTypes';
...
export const makeErrorFromApi = (httpStatus: number, data: unknown): Error => {
...
export const isClientError = (e: Error): boolean => e instanceof ApiError && e.httpStatus >= 400 && e.httpStatus <= 499;
