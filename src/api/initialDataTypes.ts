/* @flow strict-local */
import { CrossRealmBot, RealmEmojiById, RealmFilter, Stream, Subscription, User, UserGroup, UserPresence, UserStatusMapObject } from './apiTypes';
...
export type InitialDataRealm = {
  ...
  realm_message_retention_days: number | undefined | null;
  realm_name: string;
...
export type InitialData = {} | InitialDataBase | InitialDataAlertWords | InitialDataMessage | InitialDataMutedTopics | InitialDataPresence | InitialDataRealm | InitialDataRealmEmoji | InitialDataRealmFilters | InitialDataRealmUser | InitialDataRealmUserGroups | InitialDataStream | InitialDataSubscription | InitialDataUpdateDisplaySettings | InitialDataUpdateGlobalNotifications | InitialDataUpdateMessageFlags | InitialDataUserStatus;
